  ...
  return (
    <div style={{ overflowX: "clip" }}>
      ...
      <section style={{
        ...
        <MorphBlob color={t.accent} size={380} style={{ top: -160, left: -140, opacity: 0.1 }} />
        <MorphBlob color={isDark ? "#10B981" : "#059669"} size={300} style={{ bottom: -100, right: -120, opacity: 0.07 }} />
      ...
      <section style={{ padding: "20px 0 100px" }}>
        <div style={{ ...S.container, maxWidth: 840, margin: "0 auto" }}>
          ...
          {/* ── Contact block ── */}
          <FadeIn delay={tr.sections.length * 0.04}>
            <div style={{
              ...glass,
              ...
              <a href={`mailto:${tr.contactEmail}`} className="nav-link" style={{
